...
const ConnectionStatus = () => {
  ...
  const checkConnections = async () => {
    try {
      ...
      setServerStatus(healthResponse.status === 'healthy' ? 'connected' : 'error');
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">{getStatusText(serverStatus)}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">{getStatusText(dbStatus)}</span>
          </div>
        </div>
